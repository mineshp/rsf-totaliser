...
export default function Index() {
  ...
  return (
    <main className="relative min-h-screen bg-rsfRed-400 sm:flex sm:items-center sm:justify-center">
      <div className="relative sm:pb-16 sm:pt-8">
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div
            className="flex items-center bg-red-200 px-4 py-3 text-sm font-bold text-red-900"
            role="alert"
          >
            <svg
            ...
            <p>
              {`Totaliser running for today between 5am - 9pm, refresh page for
              latest totals, last update ${lastRequested}.`}
            </p>
          </div>
          <h2 className="text-bold py-2 text-lg uppercase text-white">
            Daily Total
          </h2>
          <div className="pt-2 sm:rounded-full">
